...
public class Main extends javax.swing.JFrame {
   ...
   static Account acc;
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     String name = null;
	long num;
	name = JOptionPane.showInputDialog(null, "Enter Account Holder Name:", "Create Account",
		JOptionPane.OK_CANCEL_OPTION);

	num = 1332522123;
	acc = new Account(name, num);
	int strDialogResponse = JOptionPane.showConfirmDialog(this, "Enter Account Holder Name:", "Create Account",
		JOptionPane.OK_CANCEL_OPTION);
	if (strDialogResponse == JOptionPane.OK_OPTION) {
	    jLabel1.setText("Account Entered." + acc.getAccHolder());
	} else if (strDialogResponse == JOptionPane.CANCEL_OPTION) {
	    jLabel1.setText("Cancelled Operation");
	}
